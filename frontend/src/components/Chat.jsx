  ...
  const handleSend = async (text) => {
    ...
    try {
      ...
      const featureMessages = {
        ...
        firebase: 'Firebase 서비스를 구현하시려면 아래 패키지를 추천드립니다! 🔥',
        storage: '데이터 저장 및 데이터베이스 기능을 구현하시려면 아래 패키지를 추천드립니다! 💾',
        ui_design: '세련된 디자인과 애니메이션을 구현하시려면 아래 패키지를 추천드립니다! ✨',
        forms: '입력 폼과 유효성 검사 기능을 구현하시려면 아래 패키지를 추천드립니다! 📝',
        device: '장치 권한 및 하드웨어 기능을 사용하시려면 아래 패키지를 추천드립니다! 📱',
        native: 'Native 연동 및 Desktop 기능을 구현하시려면 아래 패키지를 추천드립니다! 💻',
        utils: '다양한 유틸리티와 헬퍼 기능을 구현하시려면 아래 패키지를 추천드립니다! 🛠️',
        rendering: '콘텐츠 렌더링 및 파싱 기능을 구현하시려면 아래 패키지를 추천드립니다! 🖼️',
      }
